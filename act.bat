...
echo You might want to consider thanking Skys#5500 for this activator.
echo edited and written by Skys#5500. (@justaninternetuser)
echo Please go ahead and restart your computer.
